...
复合长表从 2005-01-01 开始；2026-09-21 重新生成后，共 239,942 条版本事件。CN 55 个字段，US 18 个字段，GLB 54 个字段。本次包含综合 PMI、调查失业率和服务业生产指数的 Wind D 级中段补缺，详情见 [补缺核查](../wind_midgap_20260921/README.md)。
