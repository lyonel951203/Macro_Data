...
import pytest
spec=importlib.util.spec_from_file_location('nbs_old',Path(__file__).resolve().parents[1]/'scripts/review_nbs_pre2010.py');m=importlib.util.module_from_spec(spec);spec.loader.exec_module(m)
